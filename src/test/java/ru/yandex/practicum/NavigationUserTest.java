...
public class NavigationUserTest extends BaseTest {
  ...
  private NavigationUserPage navigationUserPage;
  ...
  public void checkSauce2() {
    Assert.assertTrue(navigationUserPage.selectSauce());
  }
  ...
  public void checkBun() {
    Assert.assertTrue(navigationUserPage.selectBun());
  }
  ...
  public void checkFilling() {
    Assert.assertTrue(navigationUserPage.selectFilling());
  }
